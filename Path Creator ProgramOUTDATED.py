...
def victorSierra(droneSpeed,driftSpeed,driftAngle,legTime): #Creates a path using sector search method used by the US and Canadian coastguards
   ...
   #Finds the horizontal and vertical velocity for each leg.
    ...
    #Finds the horiziontal and vertical components of the drift speed after converting the drift angle to radians
...
moduleIsRunningStandalone = __name__ == "__main__"
if moduleIsRunningStandalone:
    ...
    driftAngle = float(input("What is the drift angle of the target"))#Do not say 0
